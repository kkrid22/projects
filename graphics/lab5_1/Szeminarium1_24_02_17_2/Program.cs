...
namespace Szeminarium1_24_02_17_2
{
    internal static class Program
    {
        ...
        private static unsafe void DrawPulsingTeapot()
        {
            ...
            var modelMatrixForCenterCube = Matrix4X4.CreateScale(0.1f);
            ...
            Gl.BindTexture(TextureTarget.Texture2D, teapot.Texture.Value);
        ...
        {
            using (Stream shaderStream = typeof(Program).Assembly.GetManifestResourceStream("Szeminarium1_24_02_17_2.Shader." + shaderFileName))
